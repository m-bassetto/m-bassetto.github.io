...
% This is a light version of hetprob.m adopted for EU GSP paper.
% (Iterative computation of the maturity structure that makes the golden rule
% efficient was excluded for this code - no need).
...
alphcurr=NaN;  % for compatibility with hetprob.m