function [prdiff,dprdiff]=nashfunexo(temp,bet,hbet,gam,R,n,phi,sig,cfpik,...
...
%in the utilities to find the Nash bargaining solution
...
diffuo=log(co)-log(R*k)+phi*(hbet/bet)*g^(1-sig)/(1-sig);
