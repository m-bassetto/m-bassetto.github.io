...
DOUBLE PRECISION, PARAMETER :: beta=1./(6.-.84) ! Pure Discount factor
DOUBLE PRECISION, PARAMETER :: theta=1.0 !Probability of surviving (must be >0)
DOUBLE PRECISION, PARAMETER :: tbeta=beta*theta 
DOUBLE PRECISION, PARAMETER :: n=1. !Population growth rate
DOUBLE PRECISION, PARAMETER :: alpha=0.2 !Debt repayment rate
...
DOUBLE PRECISION, PARAMETER :: deltak=0.84 !Depreciation rates for k
DOUBLE PRECISION, PARAMETER :: deltapk=0.6 !Depreciation rates for pk
...
DOUBLE PRECISION, PARAMETER :: r=5. !Return on Capital
...
DOUBLE PRECISION, PARAMETER :: adj=0.025 !adjustment factor
DOUBLE PRECISION, PARAMETER :: adjtol=0.007 ! tolerance of values close to bound
