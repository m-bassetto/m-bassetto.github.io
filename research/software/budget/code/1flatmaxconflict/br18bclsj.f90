...
!
! Last changed by Vadym Lepetyuk, September 13, 2004
...
CALL FDATE(datetime); WRITE(*,*) 'Start of the program: ',datetime
...
csi%bmin=-0.5; csi%bmax=2.0  !Boundaries for b
csi%pkmin=0.0; csi%pkmax=1.0  !Boundaries for pk
CALL initgrid(csi)
...
CALL FDATE(datetime); WRITE(*,*) 'End of the program: ',datetime
